...
public class AbysmTextureKeys {
	public static final TextureKey CROWN_PETAL_KEY = TextureKey.of("petal");
	public static final TextureKey CROWN_INNER_KEY = TextureKey.of("inner");
