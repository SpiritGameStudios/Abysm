...
//		return 0.5F + 2.0F * Mth.clamp(Mth.cos(world.getDayTime().getTimeOfDay(1.0F) * Mth.TWO_PI), -0.25F, 0.25F);
//	}
//
//	public static Holder<Biome> getBiome(ClientLevel world, Camera camera) {
//		return world.getBiome(camera.blockPosition());
//	}
//
...
//			return ARGB.srgbLerp(lightness, nightWaterFogColor, original);
//		} else {
//			return original;
//		}
//	}
