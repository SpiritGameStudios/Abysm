...
public class BigFloralFishEntityRenderer<R extends LivingEntityRenderState & GeoRenderState> extends AbstractFishEntityRenderer<BigFloralFishEntity, R> {
	public BigFloralFishEntityRenderer(EntityRendererProvider.Context context) {
	...
	public static class BigFloralFishEntityModel extends DefaultedEntityGeoModel<BigFloralFishEntity> {
