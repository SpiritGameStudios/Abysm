...
public class LightmapAdjustment {
	...
	public static void adjustLightmap(ClientPlayerEntity player, ClientWorld clientWorld, GpuTexture mainTexture, GpuTexture secondaryTexture, float tickProgress) {
