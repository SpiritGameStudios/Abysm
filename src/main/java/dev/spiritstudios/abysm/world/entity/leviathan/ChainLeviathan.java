...
public abstract class ChainLeviathan extends Leviathan {

	protected static final ImmutableList<? extends SensorType<? extends Sensor<? super ChainLeviathan>>> SENSORS = ImmutableList.of(
	...
	public ChainLeviathan(EntityType<? extends WaterAnimal> entityType, Level world) {
		super(entityType, world);
	}

	@Override
	protected Brain.Provider<ChainLeviathan> brainProvider() {
	...
	@Override
	public Brain<ChainLeviathan> getBrain() {
		return (Brain<ChainLeviathan>) super.getBrain();
	}

	@Override
	protected void tickPartUpdates() {
		List<? extends EntityPart<Leviathan>> parts = this.getTailParts();
		...
		for (int index = 0; index < parts.size(); index++) {
			EntityPart<Leviathan> leviathanPart = parts.get(index);
	...
	public List<? extends EntityPart<Leviathan>> getTailParts() {
	...
	public static class LeviathanBrain {
		...
		protected static Brain<ChainLeviathan> create(Brain<ChainLeviathan> brain) {
		...
		private static void addFightActivities(Brain<ChainLeviathan> brain) {
		...
		private static void addCoreActivities(Brain<ChainLeviathan> brain) {
			brain.addActivity(
				Activity.CORE,
				0,
				ImmutableList.of(
		...
		private static void addIdleActivities(Brain<ChainLeviathan> brain) {
			brain.addActivity(
				Activity.IDLE,
				ImmutableList.of(
		...
		public static void updateActivities(ChainLeviathan leviathan) {
			Brain<ChainLeviathan> brain = leviathan.getBrain();
		...
		private static Optional<? extends LivingEntity> getAttackTarget(ServerLevel serverWorld, ChainLeviathan leviathan) {
