...
public final class InkdepthRealmBiome extends AbysmBiome {
	...
	public EnvironmentAttributeMap.Builder createAttributes() {
		return EnvironmentAttributeMap.builder()
			.set(EnvironmentAttributes.WATER_FOG_COLOR, 0x111112)
			.set(EnvironmentAttributes.FOG_COLOR, 0x111112)
			.set(EnvironmentAttributes.SKY_COLOR, OverworldBiomes.calculateSkyColor(this.temperature))
			.set(EnvironmentAttributes.AMBIENT_SOUNDS, AmbientSounds.LEGACY_CAVE_SETTINGS)
			.set(EnvironmentAttributes.BACKGROUND_MUSIC, new BackgroundMusic(AbysmSoundEvents.MUSIC_OVERWORLD_INKDEPTH_REALM));
	}
