...
public class AbysmEntityTypes {
	public static final EntityType<SmallFloralFishEntity> SMALL_FLORAL_FISH = register(
		"floral_fish_small",
		EntityType.Builder
			.of(SmallFloralFishEntity::new, MobCategory.WATER_AMBIENT)
			.sized(0.4f, 0.4f)
			.eyeHeight(0.35f)
	...
	public static final EntityType<BigFloralFishEntity> BIG_FLORAL_FISH = register(
		"floral_fish_big",
		EntityType.Builder
			.of(BigFloralFishEntity::new, MobCategory.WATER_AMBIENT)
			.sized(0.6f, 0.5f)
			.eyeHeight(0.375f)
			.clientTrackingRange(4)
	);
	...
	public static void init() {
		FabricDefaultAttributeRegistry.register(SMALL_FLORAL_FISH, SmallFloralFishEntity.createAttributes());
		FabricDefaultAttributeRegistry.register(BIG_FLORAL_FISH, BigFloralFishEntity.createAttributes());
