...
public abstract class Leviathan<L extends Leviathan<L>> extends MobEntity implements Monster, PartHolder<Leviathan<L>> {
	...
	public boolean damagePart(ServerWorld world, LeviathanPart<L> part, DamageSource source, float amount) {
