...
public class DensityBlobStructurePiece extends StructurePiece implements DensityBlobHolder {
	...
	public DensityBlobStructurePiece(ResourceLocation identifier, int x, int y, int z, DensityBlob densityBlob) {
		super(
	...
	public static ResourceLocation idFromString(String string) {
		ResourceLocation idNullable = ResourceLocation.tryParse(string);
